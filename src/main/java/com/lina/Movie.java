...
public class Movie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3057379244363912784L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Movie\",\"namespace\":\"com.lina\",\"fields\":[{\"name\":\"movie_name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Name of Movie\"},{\"name\":\"genre\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Genre of Movie\"}],\"version\":\"1\"}");
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: movie_name = (java.lang.String)value$; break;
    case 1: genre = (java.lang.String)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static com.lina.Movie.Builder newBuilder() {
    return new com.lina.Movie.Builder();
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static com.lina.Movie.Builder newBuilder(com.lina.Movie.Builder other) {
    if (other == null) {
      return new com.lina.Movie.Builder();
    } else {
      return new com.lina.Movie.Builder(other);
    }
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static com.lina.Movie.Builder newBuilder(com.lina.Movie other) {
    if (other == null) {
      return new com.lina.Movie.Builder();
    } else {
      return new com.lina.Movie.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Movie>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.lina.Movie.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.lina.Movie other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.movie_name)) {
        this.movie_name = data().deepCopy(fields()[0].schema(), other.movie_name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lina.Movie.Builder setMovieName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lina.Movie.Builder clearMovieName() {
      movie_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lina.Movie.Builder setGenre(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lina.Movie.Builder clearGenre() {
      genre = null;
